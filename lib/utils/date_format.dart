class DateFormat {
  ...
  static List<String> monthShort = const <String>[
    'Jan',
    'Feb',
    'Mar',
    'Apr',
  ...
  static List<String> dayLong = const [
    'Monday',
    'Tuesday',
    'Wednesday',
    'Thursday',
  ...
  static List<String> dayShortZH = const [
    '周一',
    '周二',
    '周三',
    '周四',
  ...
  static List<String> dayLongZH = const [
    '星期一',
    '星期二',
    '星期三',
    '星期四',
